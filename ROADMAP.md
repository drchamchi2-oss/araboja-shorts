...
This roadmap tracks near-term work that keeps `araboja-shorts` useful, testable, and safer to maintain as a public OSS project.
...
- [#9](https://github.com/drchamchi2-oss/araboja-shorts/issues/9): Migrated URL cache keys to SHA256 and removed the Bandit B324 skip.
- [#10](https://github.com/drchamchi2-oss/araboja-shorts/issues/10): Added fixture-based tests for subtitle timing edge cases.
- [#11](https://github.com/drchamchi2-oss/araboja-shorts/issues/11): Recorded media provider attribution metadata in generated outputs.
- [#12](https://github.com/drchamchi2-oss/araboja-shorts/issues/12): Added dry-run mode for topic and script generation checks.
- [#13](https://github.com/drchamchi2-oss/araboja-shorts/issues/13): Split media and rendering helpers into focused modules.
